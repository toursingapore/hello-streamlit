    ...
    with st.container(border=True): 
        ...
        if add_radio == "Generate image from prompt":
            ...
            st.info("""
                    ...
                    [https://media1.nguoiduatin.vn/media/ha-thi-kim-dung/2020/02/14/p.jpg|https://static.pullandbear.net/2/photos//2024/V/0/2/p/8240/540/800/8240540800_2_6_8.jpg](#code)
                """)
