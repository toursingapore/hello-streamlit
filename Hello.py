                            ...
                            for user_input in user_input_arr:
                                ...
                                with st.spinner('Wait for it...'): 
                                    ...
                                    if use_proxy:
                                        ...
                                        proxies = {
                                            http: 'scrapingant&proxy_country=US&browser=false:270269b10ca74f8d918852baed658eb3@proxy.scrapingant.com:8080',
                                            https: 'scrapingant&proxy_country=US&browser=false:270269b10ca74f8d918852baed658eb3@proxy.scrapingant.com:443'
                                        }
                                        #Site 1 the check proxy IP
                                        response = s.get("http://ip-api.com/json", proxies=proxies, verify=False)
                                        st.write(response.json())
